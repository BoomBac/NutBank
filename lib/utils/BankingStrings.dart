const Banking_lbl_app_Name = "Nut Bank";
...
const Banking_lbl_Walk1SubTitle = "每一个付款过程都是如此简单和无忧无虑，我不需要担心被诈骗。";
const Banking_lbl_Get_Started = "Get Started";
const Banking_lbl_SignIn = "登入";
const Banking_lbl_SignLogin = "登入/注册";
const Banking_lbl_Forgot = "忘记密码?";
const Banking_lbl_Login_with_WeChart = "或者使用微信登录";
