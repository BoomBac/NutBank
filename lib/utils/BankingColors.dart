...
const Banking_app_Background = Color.fromARGB(237, 242, 214, 250);
...
const kButtonBgColor = Color.fromARGB(183, 12, 218, 121);
const kButtonTextColor = Color.fromARGB(255, 255, 255, 255);
